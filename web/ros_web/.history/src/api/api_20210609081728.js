...
// const baseURL = "http://192.168.43.200:8081";
    ...
    switch(response.data.code) {
      case 200:
        if (!(response.data.msg.indexOf('服务已结束') >= 0 
              ...
              || response.data.msg.indexOf('命名完成') >=0
              )) {
          Message.success({
      ...
      case 640:
        ...
        break;
      case 601,605,607,610,611,612,630,700:
        Message.error({
          message: '出现未知错误，请联系管理员，错误代码：' + response.data.code,
          duration: 2 * 1000
        })
        switch(response.data.code) {
          case 601:
