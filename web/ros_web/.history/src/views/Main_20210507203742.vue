<template>
  <el-container direction="vertical" class="homepage">
    <el-header height="">
      ...
      <el-col :span="9" :offset="0"><template style="line-height: 100%">小智</template></el-col>
      <el-col :span="15" :offset="0"><el-menu
    ...
    <el-container>
      <el-main>
        ...
        <settings v-if="activeIndex == '2'"></settings>
...
.homepage {
  background-image: url("../assets/back_white.jpg");
