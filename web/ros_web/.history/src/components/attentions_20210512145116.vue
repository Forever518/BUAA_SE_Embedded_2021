  ...
  <div class="bodyBoxOut">
      ...
      <el-dialog
        ...
        <el-form :model="form" @submit.native.prevent>
          <el-form-item label="地图">
            <el-select v-model="form.mapName" filterable clearable placeholder="请选择地图" loading="mapLoading">
              <el-option
                v-for="map in maps"
                :key="map.name"
                :label="map.name"
    ...
    <div v-if="type === 'serve'" class="bodyBoxIn">
      ...
      <el-dialog
        ...
        <el-form :model="form" @submit.native.prevent>
          <el-form-item label="地图">
            <el-select v-model="form.mapName" clearable placeholder="请选择地图" loading="mapLoading">
              <el-option
                v-for="map in maps"
                :key="map.name"
                :label="map.name"
