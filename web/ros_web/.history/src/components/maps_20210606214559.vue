  ...
  <div class="bodyBoxOut">
    <el-row>
      <el-col :span="4" v-for="map in maps" :key="map.name" :offset="1">
        <el-card :body-style="{ padding: '20px'}" shadow="hover" style="width: 260px">
          ...
          <div style="padding: 6px;">
            ...
            <div style="padding: 5px">
              <el-row v-if="map.nameMode === 'show'" type="flex" justify="space-around">
                <el-col :span="6"><font size="3">地图名</font></el-col>
                <el-col :span="6"><font size="3">{{map.name}}</font></el-col>
