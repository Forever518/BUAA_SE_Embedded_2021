    ...
    <el-row>
      <el-col :span="4" v-for="map in maps" :key="map.name" :offset="1">
        <el-card :body-style="{ padding: '20px'}" shadow="hover">
          ...
          <el-container style="padding: 6px;">
            <el-row style="position:relative">
              <span style="position:absolute; weight:100px; height:150px; width: 150px; overflow: hidden; border: solid">
                <el-image 
                  class="map_image"
                  :src="map.url"
                  :fit = "'cover'"></el-image>
            ...
            <el-row style="float:right; top: 150px">
            ...
            <el-row style="float:right; top: 170px">
