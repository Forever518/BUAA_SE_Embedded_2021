          ...
          <el-form-item label="地图">
            <el-select v-model="form.mapName" filterable clearable placeholder="请选择地图" style="width: 80%!important">
              <el-option
                ...
                :label="map.name"
                :value="map.name">
                <span style="float:left; height:100%; line-height: 150px; border: solid"> {{map.name}} </span>
                <span style="float:right; weight:100px; height:150px; width: 150px; overflow: hidden;">
                  <el-image 
                    class="map_image"
                    :src="map.url"
                    :fit = "'cover'"></el-image>
          ...
          <el-form-item label="地图">
            <el-select v-model="form.mapName" filterable clearable placeholder="请选择地图" style="width: 80%!important">
              <el-option
                ...
                :label="map.name"
                :value="map.name">
                <span style="float:left; height:100%; line-height: 150px"> {{map.name}} </span>
                <span style="float:right; weight:100px; height:150px; width: 150px; overflow: hidden;">
                  <el-image 
                    class="map_image"
                    :src="map.url"
