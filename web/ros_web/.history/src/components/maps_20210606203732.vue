  ...
  <div class="bodyBoxOut">
    <el-row>
      <el-col :span="4" v-for="map in maps" :key="map.name" :offset="1">
        <el-card :body-style="{ padding: '20px'}" shadow="hover" style="width: 260px;height: 320px;">
          <el-container style="padding: 6px;">
            <el-row>
              <span style="weight:100px; height:150px; width: 150px; overflow: hidden; border: solid">
                <el-image 
                  class="map_image"
                  :src="map.url"
                  :fit = "'cover'"></el-image>
